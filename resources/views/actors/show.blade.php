        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span class="ml-2">{{ $actor['birthday'] }} ({{ $actor['age'] }} ýaşynda) Doglan ýeri: {{ $actor['place_of_birth'] }}</span>
                </div>
                ...
                <h4 class="font-semibold mt-12">Belli Filmler</h4>
